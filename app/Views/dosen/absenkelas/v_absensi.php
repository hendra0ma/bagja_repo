...
<div class="row">
    ...
    <div class="col-sm-12">
        <a href="<?= base_url('dsn/tambahJurnalDosen/' . $jadwal['id_jadwal']) ?>" class="btn btn-xs btn-flat btn-success"><i class="fa fa-plus"></i> Tambah Jurnal</a>
    </div>
    <div class="col-sm-12">
        <?php
        ...
        ?>
        <?php echo form_open('dsn/SimpanAbsen/' . $jadwal['id_jadwal'], 'enctype="multipart/form-data"') ?>
        <table class="table table-striped table-bordered table-responsive text-sm">
            ...
            <?php } ?>
            <tr>
                <td colspan="3" class="label-success">Tanda Tangan Dosen</td>
