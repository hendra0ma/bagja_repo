    ...
    public function cek_login()
    {
        ...
        if ($this->validate([
            ...
            if ($level == 1) {
                ...
                $cek_dsn = $this->ModelAuth->login_ketua_kelas($username, $password);
                if ($cek_dsn) {
                    //jika data cocok
                    session()->set('username', $cek_dsn['nim']);
                    session()->set('nama', $cek_dsn['nama_ketua']);
                    session()->set('foto', $cek_dsn['foto_ketua']);
                    session()->set('level', $level);
                    //login
